...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        DB::statement('DROP TRIGGER IF EXISTS set_created_at_jsonb_timestamps ON permissions;');
        DB::statement('DROP TRIGGER IF EXISTS set_updated_at_jsonb_timestamps ON permissions;');
    }
};
